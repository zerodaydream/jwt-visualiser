...
- "What algorithm is being used?"`;
  ...
  return (
    <div className="max-w-3xl mx-auto h-full flex flex-col relative overflow-hidden px-4 -m-6 p-6">
      ...
      <AnimatePresence>
        {cinematicState === 'docked' && (
            <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                className="mb-4 bg-claude-surface border border-claude-border rounded-lg p-3 flex justify-center items-center gap-1 shadow-sm select-none z-10 shrink-0"
            >
                <div className="flex font-mono text-sm md:text-base opacity-80">
                    <span className="text-claude-subtext opacity-50">{'{'}</span>
                    <span className="text-jwt-header font-bold">{truncate(parts[0])}</span>
                    <span className="text-claude-subtext opacity-50">{'}'}</span>
                    <span className="mx-1 text-claude-subtext">.</span>
                    <span className="text-claude-subtext opacity-50">{'{'}</span>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-claude-subtext font-mono">
              {connectionStatus === 'connected' ? 'Connected' :
               ...
               connectionStatus === 'error' ? 'Backend Unavailable' :
          ...
          >
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <div className="text-orange-300 font-semibold mb-1">Backend Server Not Running</div>
                <div className="text-claude-subtext text-[10px] leading-relaxed">
                  The AI chat feature requires the backend server to be running. Please start the backend server with:
                  <div className="mt-1 bg-black/30 p-2 rounded font-mono text-orange-300">
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 animate-fade-in relative z-10">
        ...
        <div className="text-center mb-16 relative">
            ...
            <p className="text-claude-subtext text-lg max-w-lg mx-auto leading-relaxed">
                Paste a valid JWT in the top bar to unlock the AI security analyst. 
